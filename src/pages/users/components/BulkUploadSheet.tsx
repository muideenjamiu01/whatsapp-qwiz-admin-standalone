...
export function BulkUploadSheet({ open, onOpenChange, onFileUpload }: BulkUploadSheetProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="w-[400px] sm:w-[500px] h-fit rounded-b-sm  flex flex-col">
        ...
        <div className="flex-1 py-6 space-y-6 p-2">
          ...
          {/* File Upload */}
          <div className="space-y-3">
            <h4 className="font-medium text-gray-900">Step 2: Upload Your File</h4>
